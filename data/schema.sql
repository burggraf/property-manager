...
ALTER TABLE "public"."orgs_invites" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."orgs_invites_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
GRANT ALL ON SEQUENCE "public"."orgs_invites_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."orgs_invites_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."orgs_invites_id_seq" TO "service_role";
